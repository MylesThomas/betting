"""
Backfill game totals + spreads for all 272 NFL REG 2024 games.
Snapshot: -30 min before kickoff (same as player props).
Markets: totals, spreads

Cache (checked in order):
  1. ~/Downloads/tmp/nfl_game_lines/2024/{nfl_game_id}.parquet  (local)
  2. s3://the-odds-api-mt/nfl/game_lines/2024/{nfl_game_id}.parquet

Output:
  Same two locations above.

Run:
  python scripts/backfill_game_lines_2024.py [--dry-run]
"""
...
S3_PREFIX = "nfl/game_lines/2024"
LOCAL_DIR = Path.home() / "Downloads" / "tmp" / "nfl_game_lines" / "2024"
