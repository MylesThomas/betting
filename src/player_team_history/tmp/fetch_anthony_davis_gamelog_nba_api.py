...
python src/player_team_history/tmp/fetch_anthony_davis_gamelog_nba_api.py

# Fetch specific season
python src/player_team_history/tmp/fetch_anthony_davis_gamelog_nba_api.py --season 2024-25

# Fetch entire career
python src/player_team_history/tmp/fetch_anthony_davis_gamelog_nba_api.py --season career

# Fetch different player
python src/player_team_history/tmp/fetch_anthony_davis_gamelog_nba_api.py --player "LeBron James" --season career

# Enable debug output to see all available columns
python src/player_team_history/tmp/fetch_anthony_davis_gamelog_nba_api.py --season career --debug
