...
Copy lives in lambda/ncaab_fade_revenge_daily/tmp/ for NCAAB revenge (focal_away) work:
deciding whether to put part of the bet on ML for revenge road dogs.
Original: analysis/optimize_spread_ml_weights.py
...
# From this copy (lambda/ncaab_fade_revenge_daily/tmp):
python lambda/ncaab_fade_revenge_daily/tmp/optimize_spread_ml_weights.py --sport nba --analyze-only --seasons 2025-26

# Run optimization
python .../optimize_spread_ml_weights.py --sport nba --mode generalized --seasons 2025-26 2024-25
python .../optimize_spread_ml_weights.py --sport nba --mode all --seasons 2025-26 2024-25 2023-24
...
# Project root: works from analysis/ or from lambda/.../tmp/ (find .gitignore)
def _find_project_root() -> Path:
    ...
    return Path(__file__).resolve().parent.parent.parent  # fallback: repo root from lambda/.../tmp
